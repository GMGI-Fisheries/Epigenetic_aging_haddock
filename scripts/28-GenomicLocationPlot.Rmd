...
```{r}
full_location <- read.csv("data/100p_genomiclocation.csv")
clock_location <- read.csv("data/clock_genomiclocation.csv")

scaffold_full <- read.csv("data/scaffold_loci_length_df100_AL.csv")
scaffold_clock <- read.csv("data/scaffold_loci_length_clock.csv")
...
ggsave("manuscript figures/Figure3_genomic_clock.png", width=4, height=5)
```
