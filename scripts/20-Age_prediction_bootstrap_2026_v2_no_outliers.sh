...
#SBATCH --job-name=2026_bootstrap_output_v2_no_outliers
#SBATCH --mem=150GB
#SBATCH --ntasks=12
...
Rscript /projects/gmgi/Fisheries/epiage/haddock/scripts/20-Age_prediction_bootstrap_2026_v2_no_outliers.R
